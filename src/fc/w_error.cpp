...
/*<std-header orig-src='shore'>
 ...
 $Id: w_error.cpp,v 1.58.2.14 2010/03/19 22:17:19 nhall Exp $
...
void w_error_t::operator delete(void* p) {
  block_alloc<w_error_t>::destroy_object((w_error_t*) p, true);
}
#endif
 ...
 * preferably at server start-up time, in the main thread.  
 * The installation method is generated by the Perl script.
 * \todo what is this installation method and how is it used? reference it.
 *
 * \section ERRNUM2 Generating Sets Error Codes
 ...
 *   data structures and methods will be members of the class. 
